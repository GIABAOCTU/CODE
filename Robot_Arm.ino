...
const char* ssid     = "DIEU KHIEN ROBOT NHOM 1";
const char* password = "B1811918";
...
<html>
  ...
  <body class="noselect" align="center" style="background-color:white">
    ...
    <h1 style="color: teal;text-align:center;">Technical Project ROBOT</h1>
    <h2 style="color: teal;text-align:center;">Controlling the ROBOT Arm Group 1</h2>
